...
CULTIVATE_TRAINING_SELECT = UI("CULTIVATE_TRAINING_SELECT",
                               [template.UI_CULTIVATE_TRAINING_SELECT, template.UI_CULTIVATE_TRAINING_SELECT_1], [])
...
CULTIVATE_CATCH_DOLL_GAME = UI("CULTIVATE_CATCH_DOLL_GAME",
                               [template.UI_CULTIVATE_CATCH_DOLL_GAME_1, template.UI_CULTIVATE_CATCH_DOLL_GAME_2], [])
CULTIVATE_CATCH_DOLL_GAME_RESULT = UI("CULTIVATE_CATCH_DOLL_GAME", [template.UI_CULTIVATE_CATCH_DOLL_GAME_RESULT_1,
                                                                    template.UI_CULTIVATE_CATCH_DOLL_GAME_RESULT_2], [])
